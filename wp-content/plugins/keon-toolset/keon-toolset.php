...
if( keon_toolset_get_theme_slug() == 'shoppable-fashion' || keon_toolset_get_theme_slug() == 'shoppable-wardrobe' || keon_toolset_get_theme_slug() == 'shoppable-marketplace' || keon_toolset_get_theme_slug() == 'shoppable-grocery-store' ){
